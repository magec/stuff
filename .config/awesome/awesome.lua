...
--  Aquí enchufo mis teclas
    ...
    awful.key({ modkey, "Control" }, "f", function () awful.util.spawn('opera') end),
    ...
    awful.key({ modkey, "Control" }, ".", function () awful.util.spawn('amixer -c 0 set '..channel..' 3dB-'); getVol() end),
    awful.key({ modkey, "Control" }, "-", function () awful.util.spawn('amixer -c 0 set '..channel..' 3dB+'); getVol() end),
